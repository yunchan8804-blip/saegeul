...
- 2026-08-25 Play Console 실시간 확인 기준 이메일 목록에는 2명이 등록되어 있지만, `1 / 12` 테스터만 Alpha 참여를 실제 선택했다. 이탈 여유를 포함해 총 15명 이상이 참여하도록 최소 14명을 더 모집하고, 각 계정이 웹 참여 링크에서 직접 옵트인해야 한다.
