...
elif [[ -f "${HOME}/.saegeul/companion/ai-provider-companion.py" ]]; then
    python3 "${HOME}/.saegeul/companion/ai-provider-companion.py" --gateway-port 9211 --tailscale-https-port 9210
else
